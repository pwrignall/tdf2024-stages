const stages_data = {
  ...
  "stage-20": {
    name: "\u00c9tape 20",
    date: "2024-07-20T12:00:00+0200",
    location: "Nice to <nobr>Col de la Couillole</nobr>",
...
Object.keys(stages_data).forEach((stageKey) => {
  ...
  stageHeader.textContent += ` : ${new Date(stages_data[stageKey].date)
